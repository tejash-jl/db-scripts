...
--     '',  -- the VC template from the JSON
--     NULL,  -- doctype from JSON
--     NULL,  -- vct for SD-JWT VC
--     'https://www.w3.org/ns/credentials/v2',  -- context as comma-separated string
--     -- 'https://www.w3.org/ns/credentials/v2',
--     'NationalIDCredential,VerifiableCredential',  -- credential_type as comma-separated string
--     'ldp_vc',  -- credential_format
--     'did:web:Nandeesh778.github.io:certify-local4:certify_did',  -- did_url
...
--     '[{"name": "NationalIDCredential Verifiable Credential", "locale": "en", "logo": {"url": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png", "alt_text": "Farmer Credential Logo"}, "background_color": "#12107c", "text_color": "#FFFFFF", "background_image": { "uri": "https://mosip.github.io/inji-config/logos/agro-vertias-logo.png" }}]'::JSONB,  -- display
--     ARRAY['firstName', 'lastName', 'email', 'phoneNumber', 'gender', 'dateOfBirth', 'nationalIdNumber'],  -- display_order
--     'mosip_identity_vc_ldp',  -- scope
...
--     '{"firstName": {"display": [{"name": "First Name", "locale": "en"}]}, "lastName": {"display": [{"name": "Last Name", "locale": "en"}]}, "phoneNumber": {"display": [{"name": "phoneNumber", "locale": "en"}]}, "gender": {"display": [{"name": "Gender", "locale": "en"}]}}'::JSONB,  -- credential_subject
...
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('ROOT', 4, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_SERVICE', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_PARTNER', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_VC_SIGN_RSA', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_VC_SIGN_ED25519', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('BASE', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_VC_SIGN_EC_K1', 3, 1, 'NA', true, 'mosipadmin', now());
-- INSERT INTO certify.key_policy_def(APP_ID,KEY_VALIDITY_DURATION,PRE_EXPIRE_DAYS,ACCESS_ALLOWED,IS_ACTIVE,CR_BY,CR_DTIMES) VALUES('CERTIFY_VC_SIGN_EC_R1', 3, 1, 'NA', true, 'mosipadmin', now());
...
CREATE TABLE IF NOT EXISTS credential_status_transaction (
    ...
    is_processed BOOLEAN NOT NULL DEFAULT FALSE,                          -- Update timestamp
...
CREATE INDEX IF NOT EXISTS idx_cst_is_processed_created ON credential_status_transaction (is_processed, cr_dtimes);